...
export class MicroserviciosService {
  ...
  SesionCliente(correo:string,password:string){
    ...
    let urlAPI = 'http://35.225.195.5:3003/authCliente';
  ...
  SesionMedico(correo:string,password:string){
    let urlAPI = 'http://35.225.195.5:3003/authMedico';
    return this._http.post(urlAPI,{
      "email": correo,
      "pass": password,
  ...
  RegistrarMedico(Nombre:string,Apellido:string,password:string, email:string,Chas:string){
    let urlAPI = 'http://35.225.195.5:3003/regisMedico';
    return this._http.post(urlAPI,{
      "Nombre": Nombre,
      "Apellido": Apellido,
      "password": password,
  ...
  registrarCliente(Nombre:string,Apellido:string,password:string, email:string, genero:string, fecha:string,foto:string, Chas:string){
    let urlAPI = 'http://35.225.195.5:3003/regisCliente';
    return this._http.post(urlAPI,{
      "Nombre": Nombre,
      "Apellido": Apellido,
      "password": password,
  ...
  ActivarCuenta(correo:string,codigo:string,tipo:string){
    let urlAPI = 'http://35.225.195.5:3003/authCuenta';
    return this._http.post(urlAPI,{
      "email": correo,
      "codigo": codigo,
      "tipo":tipo
  ...
  CorreoCuenta(email:string,codigo:string,nombre:string,password:string){
    let urlAPI = 'http://35.225.195.5:3003/Correo';
    return this._http.post(urlAPI,{
      "email": email,
      "codigo": codigo,
      "nombre":nombre,
  ...
  Contactanos(nombre:string,asunto:string,correo:string){
    let urlAPI = 'http://35.225.195.5:3003/Respuesta';
    return this._http.post(urlAPI,{
      "nombre": nombre,
      "asunto": asunto,
      "correo":correo,
  ...
  InfoContacanos(nombre:string,asunto:string,correo:string,mensaje:string){
    let urlAPI = 'http://35.225.195.5:3003/MensajeC';
    return this._http.post(urlAPI,{
      "nombre": nombre,
      "asunto": asunto,
      "correo":correo,
  ...
  ActualizarCliente(user:number,Nombre:string,Apellido:string,
    ...
    let urlAPI = 'http://35.225.195.5:3003/UpdateCliente';
    return this._http.post(urlAPI,{
      "user": user,
      "Nombre": Nombre,
      "Apellido":Apellido,
  ...
  ActualizarMedico(user:number,Nombre:string,Apellido:string,
    ...
    let urlAPI = 'http://35.225.195.5:3003/UpdateMedico';
    return this._http.post(urlAPI,{
      "User": user,
      "Nombre": Nombre,
      "Apellido":Apellido,
  ...
  ObtenerFicha(user:number){
    let urlAPI = 'http://35.225.195.5:3003/ExisteFicha';
    return this._http.post(urlAPI,{
  ...
  RegistrarFicha(External_ID_Cliente:number,Estatura:number,
    ...
    let urlAPI = 'http://35.225.195.5:3003/regisFicha';
    return this._http.post(urlAPI,{
  ...
  ActualizarFicha(External_ID_Ficha:number,External_ID_Cliente:number,Estatura:number,
    ...
    let urlAPI = 'http://35.225.195.5:3003/UpdateFicha';
    return this._http.post(urlAPI,{
  ...
  ExisteMedico(email:string){
    let urlAPI = 'http://35.225.195.5:6003/CorreoMedico';
    return this._http.post(urlAPI,{
      "email": email
    })
  }
  ExisteCliente(email:string){
    let urlAPI = 'http://35.225.195.5:6003/CorreoCliente';
    return this._http.post(urlAPI,{
      "email": email
    })
  }
  ExisteAsignacionMedica(External_ID_Cliente:number,External_ID_Medico:number){
    let urlAPI = 'http://35.225.195.5:6003/ExisteAsignacionMedica';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
  ...
  AsignacionMedica(External_ID_Cliente:number,External_ID_Medico:number){
    let urlAPI = 'http://35.225.195.5:6003/AsignacionMedica';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "External_ID_Medico":External_ID_Medico
    })
  ...
  :Observable<any>{
    let urlAPI = 'http://35.225.195.5:6003/AgregarMensaje';
    return this._http.post(urlAPI,{
  ...
  Mensajes(Email:string){
    let urlAPI = 'http://35.225.195.5:6003/MostrarMensajes';
    return this._http.post(urlAPI,{
      "Email": Email
    })
  }
  IdHematologa(Nombre:string){
    let urlAPI = 'http://35.225.195.5:5003/idHematologia';
    return this._http.post(urlAPI,{
      "Nombre": Nombre
    })
  }
  ...
  :Observable<any>{
    let urlAPI = 'http://35.225.195.5:5003/RegistrarHematologia';
    return this._http.post(urlAPI,{
  ...
  ObtenerHematologiasTotales(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:5003/MostrarHematologias';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente
    })
  }
  ...
  ObtenerNombreHematologias(){
    let urlAPI = 'http://35.225.195.5:5003/Hematologias';
    return this._http.post(urlAPI,{
      "Nombre":"Nombre"
    })
  }
  ...
  verHematologias(External_ID_Cliente:number,Internal_ID_Hematologia:number,Fecha_Registro:string,Fecha_Registro2:string){
    let urlAPI = 'http://35.225.195.5:5003/BuscarHematologia';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "Internal_ID_Hematologia":Internal_ID_Hematologia,
      "Fecha_Registro": Fecha_Registro,
  ...
  IdHematologaReporte(Nombre:string){
    let urlAPI = 'http://35.225.195.5:8003/idHematologia';
    return this._http.post(urlAPI,{
      "Nombre": Nombre
    })
  }
  ...
  verHematologiasReportes(External_ID_Cliente:number,Internal_ID_Hematologia:number,Fecha_Registro:string,Fecha_Registro2:string){
    let urlAPI = 'http://35.225.195.5:8003/BuscarHematologia';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "Internal_ID_Hematologia":Internal_ID_Hematologia,
      "Fecha_Registro": Fecha_Registro,
  ...
  ObtenerNombreHematologiasReportes(){
    let urlAPI = 'http://35.225.195.5:8003/Hematologias';
    return this._http.post(urlAPI,{
      "Nombre":"Nombre"
    })
  }
  ...
  ObtenerPrePost(External_ID_Cliente:number,Fecha_Registro:string,Fecha_Registro2:string){
    let urlAPI = 'http://35.225.195.5:8003/BuscarPrePost';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "Fecha_Registro": Fecha_Registro,
      "Fecha_Registro2":Fecha_Registro2
  ...
  ObtenerTotalGlucosa(External_ID_Cliente:number,Fecha_Registro:string,Fecha_Registro2:string){
    let urlAPI = 'http://35.225.195.5:8003/TotalGlucosa';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "Fecha_Registro": Fecha_Registro,
      "Fecha_Registro2":Fecha_Registro2
  ...
  ObtenerDosColesterol(External_ID_Cliente:number,Fecha_Registro:string,Fecha_Registro2:string){
    let urlAPI = 'http://35.225.195.5:8003/BuscarColesterol';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "Fecha_Registro": Fecha_Registro,
      "Fecha_Registro2":Fecha_Registro2
  ...
  verHematologiasReportes2(External_ID_Cliente:number,Internal_ID_Hematologia:number){
    let urlAPI = 'http://35.225.195.5:8003/BuscarHematologia2';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente,
      "Internal_ID_Hematologia":Internal_ID_Hematologia
    })
  ...
  ObtenerPrePost2(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:8003/BuscarPrePost2';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente
    })
  }
  ObtenerTotalGlucosa2(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:8003/TotalGlucosa2';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente
    })
  }
  ObtenerDosColesterol2(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:8003/BuscarColesterol2';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente
    })
  }
  ...
  ObtenerPacientes(External_ID_Medico:number){
    let urlAPI = 'http://35.225.195.5:7003/MisPacientes';
    return this._http.post(urlAPI,{
      "External_ID_Medico": External_ID_Medico
    })
  }
  DatosPaciente(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:7003/DatosPaciente';
    return this._http.post(urlAPI,{
      "External_ID_Cliente": External_ID_Cliente
    })
  }
  Relacion(External_ID_Medico:number,Email:string){
    let urlAPI = 'http://35.225.195.5:7003/Relacion';
    return this._http.post(urlAPI,{
      "External_ID_Medico": External_ID_Medico,
      "Email":Email
    })
  ...
  CodigoPaciente(Email:string){
    let urlAPI = 'http://35.225.195.5:7003/CodigoPaciente';
    return this._http.post(urlAPI,{
      "Email":Email
    })
  }
  Asignacion(External_ID_Cliente:number,External_ID_Medico:number):Observable<any>{
    let urlAPI = 'http://35.225.195.5:7003/Asignacion';
    return this._http.post(urlAPI,{
      "External_ID_Cliente":External_ID_Cliente,
      "External_ID_Medico": External_ID_Medico
    }).pipe(
  ...
  MenuIntolerancias(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:4003/Intolerancias';
    return this._http.post(urlAPI,{
      "External_ID_Cliente" : External_ID_Cliente
    });
  }
  Rutinas(){
    let urlAPI = 'http://35.225.195.5:4003/Rutinas';
    return this._http.post(urlAPI,{
      "Nombre" : "HopeDiabetic"
    });
  }
  RutinasNivel(Nivel:string){
    let urlAPI = 'http://35.225.195.5:4003/RutinasNivel';
    return this._http.post(urlAPI,{
      "Nivel" : Nivel
    });
  }
  FichaRutina(External_ID_Cliente:number){
    let urlAPI = 'http://35.225.195.5:4003/FichaRecomendacion';
    return this._http.post(urlAPI,{
      "External_ID_Cliente" : External_ID_Cliente
    });
  }
